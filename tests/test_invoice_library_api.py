...
class InvoicePrintPreviewApiTests(unittest.TestCase):
    ...
    def test_invoice_list_api_returns_paginated_dict(self):
        ...
        self.assertIn("service_period_options", payload)
...
class InvoiceLibraryUiStaticTests(unittest.TestCase):
    def test_invoice_library_html_has_simplified_filter_controls(self):
        ...
        self.assertNotIn('id="invoiceCustomDateRange"', html)
    ...
    def test_invoice_library_js_has_print_preview_and_pdf_buttons(self):
        ...
        self.assertIn("servicePeriodOptions", js)
        self.assertIn("statusTotals", js)
        self.assertNotIn("invoicePaymentStatusFilter", js)
        self.assertNotIn("invoiceBillToFilter", js)
        self.assertNotIn("invoiceDateFilter", js)
        self.assertNotIn("invoiceSearch", js)
