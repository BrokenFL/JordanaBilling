...
class InvoiceLibraryUiStaticTests(unittest.TestCase):
    ...
    def test_invoice_library_html_has_enhanced_columns(self):
        html = Path("app/jordana_invoice/static/review.html").read_text()
        self.assertIn("<th>Number</th><th>Invoice Date</th><th>Service Period</th><th>Bill To</th><th>Participants</th><th>Status</th><th>Payment</th><th>Total</th><th>Paid</th><th>Balance</th><th>Actions</th>", html)
